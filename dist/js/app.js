    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".images-product")) {
                let productGallery = new core(".images-product__subslide", {
                    modules: [],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 4,
                ...
                new core(".images-product__mainslide", {
                    modules: [ Thumb ],
                    observer: true,
                    observeParents: true,
                    slidesPerView: 1,
...
***************************************************************************** */
            ...
            galleries.forEach((gallery => {
                galleyItems.push({
                    ...
                    galleryClass: lightgallery_es5(gallery, {
                        selector: ".images-product__image",
        ...
        if (inputsPriceSlider.length) {
            ...
            inputsPriceSlider.forEach(((item, index) => {
                item.addEventListener("input", (function(e) {
                    0 == index ? priceSlider.noUiSlider.setHandle(index, item.value) : priceSlider.noUiSlider.setHandle(index, item.value);
                }));
            }));
        }
        const menuParents = document.querySelectorAll(".menu-page__parent");
        if (!isMobile.any()) if (menuParents) for (let index = 0; index < menuParents.length; index++) {
            ...
            for (let index = 0; index < checkboxCategories.length; index++) {
                ...
                checkboxCategorie.addEventListener("input", (function(e) {
                    if (checkboxCategorie.checked && i >= 0) {
                        ...
                        --i;
                        0 !== i ? searchButton.innerHTML = `Выбрано: ${i}` : searchButton.innerHTML = `Везде`;
                    }
                }));
            }
        }
        ...
        if (filterBurger) {
            ...
            let lockToggle = (delay = 500) => {
                if (filterBurger.classList.contains("_active")) unlockBurger(delay); else lockBurger(delay);
            };
            function unlockBurger(delay = 500) {
                if (lockStatus) filterBurger.classList.remove("_active");
                lockStatus = false;
                setTimeout((function() {
                    lockStatus = true;
                }), delay);
            ...
            function lockBurger(delay = 500) {
                if (lockStatus) filterBurger.classList.add("_active");
                lockStatus = false;
                setTimeout((function() {
                    lockStatus = true;
                }), delay);
